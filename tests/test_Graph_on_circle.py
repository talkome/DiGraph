...
def create_g_10_80_1():
    graph = GraphAlgo()
    g_nx = nx.DiGraph()
    file = "../data/Graph_on_circle/G_10_80_1.json"
    ...
    end_time = time.perf_counter()
    record = end_time - start_time
    # print("g_10_80_1 networkx result:")
    # print("shortest_path(2,8)", path)
    # print("distance=", dist)
...
def create_g_100_800_1():
    graph = GraphAlgo()
    g_nx = nx.DiGraph()
    file = "../data/Graph_on_circle/G_100_800_1.json"
    graph.load_from_json(file)
    try:
        with open(file, 'r') as file:
            load_file = json.load(file)
    ...
    end_time = time.perf_counter()
    record = end_time - start_time
    # print("g_100_800_1 networkx result:")
    # print("shortest_path(2,8)", path)
    # print("distance=", dist)
    shortest_path_networkx_result.append(record)
...
def create_g_1000_8000_1():
    graph = GraphAlgo()
    g_nx = nx.DiGraph()
    file = "../data/Graph_on_circle/G_1000_8000_1.json"
    graph.load_from_json(file)
    try:
        with open(file, 'r') as file:
            load_file = json.load(file)
    ...
    end_time = time.perf_counter()
    record = end_time - start_time
    # print("g_1000_8000_1 networkx result:")
    # print("shortest_path(2,8)", path)
    # print("distance=", dist)
    shortest_path_networkx_result.append(record)
...
def create_g_10000_80000_1():
    graph = GraphAlgo()
    g_nx = nx.DiGraph()
    file = "../data/Graph_on_circle/G_10000_80000_1.json"
    graph.load_from_json(file)
    try:
        with open(file, 'r') as file:
            load_file = json.load(file)
    ...
    end_time = time.perf_counter()
    record = end_time - start_time
    # print("g_10000_80000_1 networkx result:")
    # print("shortest_path(2,8)", path)
    # print("distance=", dist)
    shortest_path_networkx_result.append(record)
...
def create_g_20000_160000_1():
    graph = GraphAlgo()
    g_nx = nx.DiGraph()
    file = "../data/Graph_on_circle/G_20000_160000_1.json"
    graph.load_from_json(file)
    try:
        with open(file, 'r') as file:
            load_file = json.load(file)
    ...
    end_time = time.perf_counter()
    record = end_time - start_time
    # print("g_20000_160000_1 networkx result:")
    # print("shortest_path(2,8)", path)
    # print("distance=", dist)
    shortest_path_networkx_result.append(record)
